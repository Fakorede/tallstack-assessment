            ...
            <div class="px-4 py-5 bg-white shadow sm:p-6 sm:rounded-md">
                <div class="grid grid-cols-6 gap-6">
                    ...
                    <div class="col-span-6 sm:col-span-4">
                        ...
                        <select wire:model.defer="role_id" class="w-full border-gray-300 rounded-md shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50" id="role">
